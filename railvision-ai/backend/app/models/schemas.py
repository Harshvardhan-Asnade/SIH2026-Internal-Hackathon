...
class ProcessingResult(BaseModel):
    ...
    # Generated Intelligence Report from RailVision AI Master
    ai_master_report: str | None = Field(default=None, description="Natural language intelligence report generated by the LLM")

    # Cached frame tracking
